...
from gym_simple_gridworlds.envs.grid_2dplot import plot_grid_world, get_state_to_plot
...
class GridEnv(gym.Env):
    ...
    def step(self, action):
        ...
        # Get cell index from (x,y) location in grid
        cell = self.grid[self.cur_state[0], self.cur_state[1]]
        ...
        return (next_x, next_y), reward, done, {'prob': prob[next_state]}
    ...
    def reset(self):
        ...
        """
        self.cur_state = self.__select_init_state__()
